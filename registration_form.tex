...
\hline
Start button &\hspace{7cm} & \hspace{7cm} \\
\hline
Collision avoidance &\hspace{7cm} & \hspace{7cm} \\
\hline
Voice of the robot  &\hspace{7cm} & \hspace{7cm} \\
\hline
Robot speaker system &\hspace{7cm} & \hspace{7cm} \\
\hline
Use of external devices &\hspace{7cm} & \hspace{7cm} \\
\hline
Demonstrate usage of continue rule&\hspace{7cm} & \hspace{7cm} \\
\hline
Other safety issues &\hspace{7cm} & \hspace{7cm} \\
\hline
Custom containers.&\hspace{7cm} & \hspace{7cm} \\
\hline
\end{tabular}\\[1cm]
