\small\begin{scorelist}[timelimit=15]
	...
	\penaltyitem[2]{40}{Asking for directional confirmation}

	\scoreheading{Human Assistance Penalties}
	...
	\penaltyitem[2]{50}{Being told/pointed where a table/\textit{Kitchen-bar} is located}
