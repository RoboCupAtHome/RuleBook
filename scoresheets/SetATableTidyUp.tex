...
The is no maximum time for this test. A maximum of 6 objects is
...
% Place unknown object near unknown object of the same class: 50
  ...
  \scoreitem[1]{10}{For asking for the meal variation and confiming the choice}
	...
	\scoreitem[6]{20}{For each successful placement of an hard to
        ...
        \scoreitem[1]{100}{For appropriately executing the opertor choice}
