...
\begin{scorelist}
	...
	\scoreitem{20}{Approach or point at the operator}

	\scoreheading{Crowd (requires report validation)}
	\scoreitem{30}{State crowd's size (with no false positives)}
	\scoreitem{60}{Reporting gender of people in the crowd}
	\setTotalScore{150}
\end{scorelist}
