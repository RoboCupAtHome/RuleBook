...
\begin{scorelist}
	...
	\scoreheading{Placing the tide-pod} %40 pts
	\scoreitem{40}{Placing the tide-pod in the dishwasher's soap compartment}
	\scoreitem{20}{Placing the tide-pod in the dishwasher (somewhere else)}
