...
\begin{scorelist}
	...
	\scoreitem{0}{Understanding the command the $1^{st}$ attempt}
	\scoreitem{0}{Random category successfully solved}
	\scoreitem{0}{Mixing categories (bonus for each extra category)}
	
	\scoreheading{HRI}
	\scoreitem{0}{Answering a predefined question}
	\scoreitem{0}{Ask for missing information}
	\scoreitem{0}{Ask for command after detecting an event}
	\scoreitem{0}{Explain in detail why the robot could not accomplish a task *}
	\scoreitem{0}{Natural handover (give or take)}
	...
	\scoreitem{30}{Open/close a door/drawer *}
	...
	\scoreitem{0}{Detect an expected event (within a reasonable amount of time) *}
	\scoreitem{0}{Detecting an unexpected event*}
	\scoreitem{0}{Provide information about changes in the environment and/or given commands*}

	\scoreheading{Navigation}
	\scoreitem{0}{Follow operator until stopped}
	\scoreitem{0}{Guide a human to location without loosing him or colliding}
	...
	\scoreitem{0}{Detect a calling/waving person}
	\scoreitem{0}{Find a person in a given room}
	\scoreitem{0}{Recognize a newly learned face correctly}
	\scoreitem{0}{State the gender of a person}
	\scoreitem{0}{State the number of people in a group}
	\scoreitem{0}{State the pose of a person *}
