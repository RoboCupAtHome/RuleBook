\begin{scorelist}[timelimit=10,attempts=1,outstanding=False,continue=False, specialpenbonus=False]
	...
	\scoreitem[10]{650}{Solve a problem}
		...
		\scorepen{650}{%
			...
			\hspace{2em}of the task will apply a percentage penalty according to \\
			\hspace{2em}similar scores in other tests.
			}
	\scoreitem{0}{%
		\hspace{1em}Solving only partsq of a gpsr command will apply \\
