...
\begin{enumerate}
	...
	{\bf\item Place:} The poster session may be held in or around the arena, but should not interfere with the robot inspection (see Section \refsec{sec:robot_inspection}).
