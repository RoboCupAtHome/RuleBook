...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item usage of (standardized) continue rule (\refsec{rule:asrcontinue}). The robot must stop anywhere between the entry and exit and wait for someone to show a QR-code encoding the text ``Continue'' as per the standardized Continue-rule. 
		  If the team has a custom alternative to ASR for the Continue Rule, this must also be demonstrated so the TC. The TC will decide after deliberation what penalty will be given when the alternative is used. 
		%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		%
