...
\begin{enumerate}
  {\bf\item Stage~I:} The maximum total score per test in Stage~I is \scoring{90 points}.
  \begin{enumerate}
    {\bf\item \iterm{Proficency Tests}:} The maximum total score per test is \scoring{15 points}. It is calculated as the average of the best two runs for that test.
    {\bf\item Open Challenge:} The maximum score for Open Challenge is \scoring{10 points}.
  ...
  \begin{enumerate}
  \item Each test has a main task. The base score for solving the main task is \scoring{25 points}.
