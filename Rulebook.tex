...
RoboZoo (open demonstration for the audience) have no changes from previous years' competitions and is intended to show to an open audience what domestic robots can do. This test grants up to 5 points.
\end{itshape}
