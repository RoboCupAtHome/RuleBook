...
\begin{itshape}
the competition comprehends a collection of \textbf{integration tests} along with an open demonstration for the audience. 
...
In the \iterm{Open Challenge} the robot must be able to show to the \iaterm{Technical Committee}{TC} the achievements on the main research line of its own team. 
This test grants up to 200 points.

\section{Robot \& team cooperation}
We encourage robots and teams to work together when performing challenges where it is allowed. 
