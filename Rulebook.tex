...
The point of this is the both eliminate good and bad luck for the robots/teams and to get a more objective view of the performance,
...
\newpage
\input{tests/ObjectConfiguration}
