...
\iterm{RoboZoo} (open demonstration for the audience) have no changes from previous years' competitions and is intended to show to an open audience what domestic robots can do.
...
Preparing and prepared robots must wait at this preparation location until commanded to start the test.
When commanded to start, the robot must move automatically to the test (start)position and may start an attempt at the test. 
