...
\begin{enumerate}
	...
	This is a \emph{forced} restart of the robot. \\

	\item \textbf{Restart:} The number of commands to be given to a robot is three regardless if the restart is used or not. 
