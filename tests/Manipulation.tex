...
The robot must reach a bookcase in which there are several objects at different shelves in the bookcase. The robot must then identify and grasp 5 of those objects and put those into a new, easy-to-reach shelve that the team/robot may choose.
...
The bookcase has at least 5 shelves between 0.30m and 1.80m from the ground. One of the shelves is empty or will be made empty when the teams chooses a shelve.
\item \textbf{Objects:} The bookcase contains 10 objects from the Scenario Objects \ref{rule:scenario_objects}.
  The robot must grasp 5 objects and identify at least those 5 objects.
