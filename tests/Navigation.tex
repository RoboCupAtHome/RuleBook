...
The robot must visit a set of waypoints while avoiding obstacles on its path and finally follow a person outside the arena.
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item Wait for the object to move away by itself (e.g.~if it is unable to identify the type of obstacle).
		  The obstacle will clear or be cleared after roughly a minute.
