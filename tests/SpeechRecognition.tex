...
For the second phase, the robot will be surrounded by a umber of people, which pose a set of questions which the robot must answer. 
The robot must look at the person asking the question and answer it. 
