...
\begin{enumerate}
	\item \textbf{Calling for assistance: } Points will only be scored for attention calling when the robot directly responds to the waving or voice calls.
	Responding in this case means starting to move toward Granny or the robot should say it detected a call etc. 
	In any case, it should be clear to the referee that the robot detected the action.
