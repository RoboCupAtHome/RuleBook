...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item The points given by each jury member are scaled to obtain a score from $0.0-1.0$. This score is multiplied by the highest score achieved on any task in Stage 2 to arrive at the \scoring{final score} for the task. 
