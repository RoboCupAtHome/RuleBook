...
\begin{enumerate}
	...
	\item \textbf{Correcting an order:} The robot should navigate back to the \quotes{party room}, find the person whose drink is missing and provide the alternatives for them to choose.\\
