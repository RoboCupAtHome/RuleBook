...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item \textit{Find the table} Only a rough location is defined beforehand
...
\begin{itemize}
    ...
    \item Announce a rough location for the table, i.e. left or right of the robot's startup location
\end{itemize}
