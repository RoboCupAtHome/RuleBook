...
\label{chap:concepts}
A set of conceptual key criteria builds the basis for the RoboCup@Home competitions. These criteria describe the general concept of the competition. The concrete rules are explained in Chapter~\refsec{chap:rules}.
