...
\item \textbf{Wait for Start Command:} Once the robot states it has finished memorizing the operator, 
  it must wait for a Start Command via ASR (or using the Continue rule if need be; Section \refsec{rule:asrcontinue}) while the operator walks around the robot and locate behind him within a crowd.
