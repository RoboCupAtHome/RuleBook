...
\end{itemize}
\item \textbf{Find the operator:} Once the crowd has been located, the robot must greet the operator and state the gender, mood (happy, sad, angry, etc.), pose (sitting, standing, rising arms, etc.). Also, it must point or approach to the operator.
...
\begin{tabularx}{\textwidth}{ X r }
	...
	\textbi{Operator}  \\
	Approach or point at the operator & 2.0 \\
	Correctly state operator's gender & 2.0 \\
