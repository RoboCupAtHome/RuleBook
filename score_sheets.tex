...
\renewcommand{\currentTest}{Take Out the Garbage}
\begin{scoresheet}
...
% P&G Dishwasher
\renewcommand{\currentTest}{P\&G Dishwasher Challenge}
\begin{scoresheet}
%\input{scoresheets/Dishwasher.tex}
\end{scoresheet}

% House Guide
\renewcommand{\currentTest}{House Guide}
\begin{scoresheet}
%\input{scoresheets/HouseGuide.tex}
\end{scoresheet}
