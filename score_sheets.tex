...
% Self Knowledge
\ifSSPL{
\renewcommand{\currentTest}{Pepper Self Knowledge and Human Understandable Communication}
\begin{scoresheet}
  \input{scoresheets/SelfKnowledge.tex}
\end{scoresheet}
}
...
\ifNotSSPL{
  \renewcommand{\currentTest}{Set a table and clean it up}
  \begin{scoresheet}
