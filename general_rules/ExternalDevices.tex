...
\begin{enumerate}
	...
	\begin{itemize}
	\item [DSPL/SSPL only] In order to make the audience to catch what is spoken to the robot, the speaker is supposed to use the \iterm{official microphone} to speak to the robot. The official microphone is used for the tasks inside the arena except SSL-related tests (\iterm{Speech and Person Recognition}). Outside the arena, the official microphone is not used.
	\end{itemize}
\end{enumerate}
