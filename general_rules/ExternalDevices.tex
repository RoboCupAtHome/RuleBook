...
\begin{enumerate}
	...
	{\bf\item Inspection:} In general, external devices are not allowed unless presented and explained to the \iaterm{Technical Committee}{TC} during the \iterm{Robot Inspection} test (see \refsec{sec_robot_inspection}).
