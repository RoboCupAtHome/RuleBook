...
\noindent \textbf{Remark:} The use of \iterm{wireless devices} is strictly prohibited. \iterm{External microphones}, hand microphones, and headsets are not allowed in OPL and it use is discouraged in DSPL and SSPL. In the DSPL add-ons that allow for a connection with an \iterm{External speaker}, be it a usb to jack plug, a usb dongle or something else are allowed in order for teams to connect to either a team brought speaker or the speakers of the arena.
