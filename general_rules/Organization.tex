...
\begin{enumerate}
	...
	\begin{enumerate}
		\item \textbf{\iterm{Proficiency Tests}:} Each proficiency test is attempted three times unless the time schedule only allows for less. The maximum total score is calculated as the average of the best two attempts for that test.
