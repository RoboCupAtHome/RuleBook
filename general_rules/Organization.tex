...
\begin{enumerate}
	\item \textbf{Stage~I:} The maximum total score (excluding special penalties and bonuses) in \iterm{Stage~I} is \scoring{100 points}.
	\begin{enumerate}
		...
		\item \textbf{RoboZoo:} The maximum score for \iterm{RoboZoo} is \scoring{5 points}.
	\end{enumerate}
