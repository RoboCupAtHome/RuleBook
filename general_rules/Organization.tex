...
\begin{enumerate}
	...
	\item \textbf{Stage~II:} The best \emph{50\% of teams} after \SONE{} advance to \STWO.\footnote{If the total number of teams is less than 12, up to 6 teams may advance to \STWO.}
...
\begin{enumerate}
	...
	\item \textbf{\iterm{\FINAL}:} The final score is normalized.
