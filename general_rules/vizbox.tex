...
The \iterm{VizBox}'s code is hosted here: \url{https://github.com/LoyVanBeek/vizbox}.
We want to show the audience a consistent presentation, so ideally, all teams run the same VizBox code.
Sharing your changes in the form of a \iterm{Pull Request} is much appreciated so all teams can benefit.
