...
To facilitate scheduling of test slots during the competition, teams are required to notify the \iaterm{Organizing Committee}{OC} which tasks will be tested in each scenario/stage two weeks before the competition. This should be considered as "soft" list, meaning, teams are not obligated to test all the tasks they notify; they are free to opt-out of the task during the competition. However, teams cannot test a task they did not notify beforehand; they are not able to opt-in.
