...
The selected tasks should be according to the number and type of test slots of the competition (see~\Cref{rule:schedule,tbl:max-elegible-tests}).
This should be considered a "soft" list, namely teams are not obliged to perform all tasks on the list and are free to opt-out of any of them during the competition; however, a team cannot participate in a task if it was not included in the notification, i.e. opting-in for a task during the competition is not possible.
...
\begin{table}[H]
\centering
\caption{Maximum number of elegible tests in Bangkok 2022}
