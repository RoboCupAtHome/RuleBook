...
To facilitate scheduling of test slots during the competition, teams are required to notify the \iaterm{Organizing Committee}{OC} which tasks will be tested in each scenario/stage, at least one month before the competition. The tasks a team can select should be according to the number and type of test slots of the competition (see~\refsec{rule:schedule}).
