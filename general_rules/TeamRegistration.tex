...
Aiming at ease test slot scheduling during the competitions, teams are required to notify the \iaterm{Organizing Committee}{OC} which tasks will be tested in each scenario/stage, at least one month before the competition.
