...
\begin{enumerate}
	...
	Natural alternative HRI interfaces (see~\refsec{rule:asralternative}) must be previously approved by the TC during the Robot Inspection (see~\refsec{sec:robot_inspection}).
\end{enumerate}
...
\begin{itemize}
	...
	\item Unilke previous years, QR codes will not be allowed as these are considered a non-natural communication.
\end{itemize}
