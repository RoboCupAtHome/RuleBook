...
\begin{enumerate}
	...
	\begin{enumerate}
		\item \textbf{\StandardObjects{}:} Objects whose image appears in the list of objects. Chosen either from the \YCBData{}.\footnote{\url{http://www.ycbbenchmarks.com/object-set/}} if available for all houses or bought local items. These are published and available for testing and training on the first setup day.
		...
		\item \textbf{\CommonObjects{}:} Worlwide available objects, for teams to acquire and train on beforehand.
	\end{enumerate}
...
\begin{itemize}
	...
	\item \textbf{\iterm{Dry Food Container}:} Dry food containers.
	...
	\item \textbf{\iterm{Worlwide available}:} A can of coke, a red pringles can, a plastic water bottle, and a solved rubik's cube. (see Figure~\ref{fig:scenario_containers}).
\end{itemize}

\begin{figure}[H]
	\centering
	\subfloat[Can of coke]{
		\includegraphics[width=0.24\textwidth]{images/coke.png}\label{fig:scenario_coke}}
	\subfloat[Red Pringles can]{
		\includegraphics[width=0.24\textwidth]{images/pringles.jpg}\label{fig:scenario_pringles}}
	\subfloat[Plastic water bottle]{
		\includegraphics[width=0.24\textwidth]{images/water.jpg}\label{fig:scenario_water_bottle}}
