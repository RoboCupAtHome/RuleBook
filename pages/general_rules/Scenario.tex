...
\begin{itemize}
	...
	\item \textbf{\iterm{Common Objects}:} A soda can, a cylindrical snack container, a plastic water bottle, and a solved Rubik’s Cube. These objects must be commonly available worldwide. (see Figure~\ref{fig:scenario_common_objects}).
\end{itemize}
