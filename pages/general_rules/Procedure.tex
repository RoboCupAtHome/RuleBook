...
\begin{itemize}
    ...
    \item The team moves the robot to the entrance (inside the arena).
...
\begin{enumerate}
	...
	Robots need to be ready to enter the \Arena{} no later than \SI{30}{\second} after the previous team ended their task. Teams can start their setup as soon as the previous team has entered the arena and the door has been closed.
