...
\begin{enumerate}
	...
	When the robot is ready to start a task, it must clearly informed the referee it is ready to start, and what it needs to do to activate the start signal.
	...
	\begin{itemize}[nosep]
		...
		\item Releasing the emergenecy stop button
	...
	\end{itemize}
	Start signals that involve the referee usage of mouses or keyboards are forbidden. 
