...
\begin{figure}[H]
    ...
    \caption{Left --- Example (failure): \textbf{0 pts} --- The shirt is completely unfolded; no fold was attempted. Center --- Example (human assistance): \textbf{200 pts} --- A human spread the clothing flat ($-200$ pts penalty); the robot did not prepare the garment independently. Right --- Example (human assistance): \textbf{250 pts} --- A human folded one half of the shirt ($-200$ pts penalty); the robot only grasped one side.}
\end{figure}
