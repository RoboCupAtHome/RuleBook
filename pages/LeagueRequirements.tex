...
\begin{itemize}
    \item Number of Fields: 2 (+1 Testing)
...
\begin{itemize}
    \item a living room
    \item a kitchen
    \item two additional rooms (bedroom, office, dining, laundry room, foyer, kids room),
\end{itemize}
...
\begin{itemize}
    ...
    \item a front loader washing machine
    \item The kitchen contains:
    \begin{itemize}
        \item a dishwasher,
        \item a sink,
...
\begin{itemize}
    ...
    \item Arrange team tables near their respective arenas.
\end{itemize}
...
\begin{itemize}
    ...
    \item Laundry Basket (two handed carry basket e.g. long and wide)
...
\begin{itemize}
    \item New Changes: 
    \begin{itemize}
        \item Different Sub-Leagues have been dissolved.
        \item A Washing Machine is now required.
        \item Bed is now optional
    \end{itemize}
