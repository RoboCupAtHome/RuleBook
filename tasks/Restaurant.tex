\section{Restaurant Challenge}\label{test:restaurant}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Each Autonomy Skip for skipping manipulation is capped at twice per order so receiving an order with three objects is not more punishing.
