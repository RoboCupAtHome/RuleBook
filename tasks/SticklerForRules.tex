...
The OC needs to:
\begin{itemize}
	\item \textbf{At least 2 hours before the test:} Select and announce the robot start location.
	\item \textbf{At least 2 hours before the test:} Select and announce which room is forbidden.
\end{itemize}
