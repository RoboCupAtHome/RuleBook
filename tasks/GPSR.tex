...
\begin{itemize}[nosep]
    \item \textbf{Locations:}
        \begin{itemize}
            \item \textbf{Task location:} The task takes place inside the \Arena{}. The \Arena{} is in its nominal configuration for this task. Commands may require the robot to manouvre to any part of the \Arena{}.
