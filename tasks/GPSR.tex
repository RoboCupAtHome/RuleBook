...
\begin{enumerate}[nosep]
	...
	\item \textbf{Understanding Commands:} The robot must correctly interpret and repeat commands given by the operator. Correctly repeating the command given by the operator counts as partially solving the problem.
\end{enumerate}
...
\begin{itemize}[nosep]
	\item If all three commands are issued together, the arena will be setup for all command executions. 
