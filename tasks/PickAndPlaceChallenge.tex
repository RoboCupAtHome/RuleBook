	...
	\item \textbf{Objects:}
		\begin{itemize}
			...
			\begin{itemize}[nosep]
				...
				\item \textit{Tableware}: One mug or bowl and one plate.
...
\begin{enumerate}[nosep]
	...
	\item \textbf{Extra surface clean up:} A surface, fixed to the floor (if possible), will have 2 objects from the common objects set. These set of objects will purposely be in an easier setting. As in the table clean up, the objects must be placed in the cabinet grouping them by category or similarity.
