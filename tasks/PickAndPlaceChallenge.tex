...
\begin{enumerate}[nosep]
	...
	\item \textbf{Use common items:} Teams must choose either the two items in the dining table or the side table. The side table objects are previously known and in a easier setup. However, a penalty is applied if the side table objects are used instead of the dining table objects.
