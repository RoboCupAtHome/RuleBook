...
\begin{itemize}[nosep]
	...
	\item \textbf{Furniture:}
		\begin{itemize}
			...
			\item \textbf{Dining table:} A table in the kitchen with objects to clean up.
			\item \textbf{Side table:} A fixed position side table with common objects (worldwide available objects). (see Figure~\ref{fig:scenario_common_objects}).
