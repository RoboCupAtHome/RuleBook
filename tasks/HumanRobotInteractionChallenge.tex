...
\begin{enumerate}[nosep]
	...
	\item \textbf{Bag handover:} If the robot has to ask the guest for help during handover, the score is reduced. If the robot tells the guest to place the bag somewhere on its structure, no points are awardsd. To score the maximum amout of points:
	\begin{itemize}[nosep]
