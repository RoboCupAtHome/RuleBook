...
\begin{enumerate}[nosep]
	...
	\begin{itemize}[nosep]
		...
		\begin{itemize}[nosep]
		\item Natural interaction (e.g.~wave and calling) 100pts score redutction.
		\item Non-natural interaction (e.g.~raising both hands and jumping) 200pts score redutction.
		\item Touching the robot (e.g.~pulling the robot's hand) 400pts score redutction.
		\end{itemize}
	\end{itemize}
