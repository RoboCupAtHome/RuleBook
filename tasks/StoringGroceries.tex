...
\noindent \textbf{Main goal:} Move objects from a table to the cabinet, grouping them by category or similarity. Refilling the cereal and milk container.\\
...
\begin{enumerate}[nosep]
	...
	\item Pour milk into the pitcher
...
\begin{itemize}
	...
	\item \textbf{Objects}:
		\begin{itemize}
			...
			\item \textbf{Cabinet objects:} Some objects are placed behind the cabinet door and cannot be accessed unless the door is open.
			\item \textbf{Containers:} The pitcher and container for the cornflakes are placed on the table.
		\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item Place container and cornflakes (as well as pitcher and milk if requested) on the table.
