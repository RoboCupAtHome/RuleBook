...
\begin{enumerate}[nosep]
	...
	\begin{enumerate}[nosep]
		...
		\item The robot can asks up to 3 questions as necessary.
...
\begin{enumerate}[nosep]
	...
	\item\textbf{Clarifying questions:} The robot is allowed to ask up to 3 clarifying questions per object. Each question applies a penalty of 150 points for that particular object.
